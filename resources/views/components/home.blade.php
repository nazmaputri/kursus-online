<!-- Home Section -->
<section id="home" class="flex items-center min-h-screen bg-sky-50 text-sky-600 rounded-b-[75px]">
        ...
        <div class="flex flex-col-reverse lg:flex-row items-center">
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center space-y-6 pt-8 lg:pt-0">
                ...
                <div class="flex space-x-4 mt-4">
                    <a href="#about" class="px-6 py-3 bg-sky-600 border border-sky-600 text-white font-bold rounded-full hover:bg-white hover:text-sky-600 transition duration-300">
                        Mulai!
                    </a>
                </div>
            </div>
...
<!-- Card Section -->
<div class="relative z-10 -mt-20 pb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition-transform hover:scale-105">
                <div class="flex justify-center py-4">
                    <img src="{{ asset('storage/quiz.png') }}" alt="Card Image" class="w-32 h-32 object-cover">
                </div>
                <div class="p-4 pt-1 text-center">
                    <h3 class="font-bold text-lg text-sky-600">Quiz</h3>
                    <p class="text-gray-600">Uji pemahaman Anda dengan quiz yang ada setelah belajar.</p>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition-transform hover:scale-105">
                <div class="flex justify-center py-4">
                    <img src="{{ asset('storage/video.png') }}" alt="Card Image" class="w-32 h-32 object-cover">
                </div>
                <div class="p-4 pt-1 text-center">
                    <h3 class="font-bold text-lg text-sky-600">Video Pembelajaran</h3>
                    <p class="text-gray-600">Pelajari materi lengkap lewat video yang disediakan oleh mentor.</p>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition-transform hover:scale-105">
                <div class="flex justify-center py-4">
                    <img src="{{ asset('storage/sertifikat.png') }}" alt="Card Image" class="w-32 h-32 object-cover">
                </div>
                <div class="p-4 pt-1 text-center">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition-transform hover:scale-105">
                <div class="flex justify-center py-4">
                    <img src="{{ asset('storage/24.png') }}" alt="Card Image" class="w-32 h-32 object-cover">
                </div>
                <div class="p-4 pt-1 text-center">
                    <h3 class="font-bold text-lg text-sky-600">Materi 24 jam</h3>
                    <p class="text-gray-600">Akses materi belajar kapan saja, 24 jam penuh.</p>
                </div>
            </div>
            <!-- Card 5 -->
            <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition-transform hover:scale-105">
                <div class="flex justify-center py-4">
                    <img src="{{ asset('storage/chat.png') }}" alt="Card Image" class="w-32 h-32 object-cover">
                </div>
                <div class="p-4 pt-1 text-center">
                    <h3 class="font-bold text-lg text-sky-600">Chat dengan Mentor</h3>
                    <p class="text-gray-600">Konsultasi langsung dengan mentor via chat.</p>
                </div>
            </div>
        </div>
    </div>
