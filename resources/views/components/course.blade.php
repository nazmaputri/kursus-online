                ...
                @foreach($courses as $course)
                    <div class="course-card bg-white border border-gray-300 rounded-lg shadow-md overflow-hidden flex-none w-80 flex-shrink-0 flex flex-col transition-transform duration-300 ease-in-out">
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            <h4 class="text-xl font-semibold text-sky-400 text-center">{{ $course->title }}</h4>
                            <p class="text-gray-600 mt-2 flex-grow text-center">{{ $course->description }}</p>
                            <div class="mt-4">
                                <a href="{{ route('login') }}" class="inline-block w-full bg-sky-400 text-white px-4 py-2 rounded-md hover:bg-sky-500 text-center">
