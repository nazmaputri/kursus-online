...
<div class="container mx-auto">
    <div class="bg-white border border-gray-300 rounded-lg shadow-md p-6 mb-6">
        ...
        <!-- Grid Kategori dengan scroll horizontal pada mode mobile -->
        <div class="overflow-x-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 whitespace-nowrap">
                @foreach($categories as $category)
                    <div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden flex min-w-[300px]">
                        <!-- Gambar di sisi kiri -->
                        <img class="p-5 w-40 h-full object-cover" src="{{ asset('storage/' . $category->image_path) }}" alt="{{ $category->name }}">
