...
<div class="container mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        <h2 class="text-3xl font-bold mb-8 inline-block border-b-2 border-gray-300 pb-2">Data Peserta</h2>
                        ...
                        <tr class="bg-white hover:bg-sky-50 user-row" data-role="{{ $user->role }}">
                            ...
                            <td class="py-3 px-6 text-center border border-gray-300 rounded-md">
                                <div class="flex items-center justify-center space-x-5">
                                    <!-- Tombol Lihat Detail -->
                                    <a href="{{ route('detaildata-peserta', ['id' => $user->id]) }}" class="text-gray-500 hover:text-gray-700">
